...
string name() pure nothrow @nogc { return "Morton Z-Curve"; }
...
void createResources( ref App_State app, bool recreate = false ) {
    ...
    app.pipeline = Meta_Graphics( app )
        .addShaderStageCreateInfo( app.createPipelineShaderStage( "example/sw_01_triangle/shader/morton.vert" ))    // deduce shader stage from file extension
        .addShaderStageCreateInfo( app.createPipelineShaderStage( "example/sw_01_triangle/shader/morton.frag" ))    // deduce shader stage from file extension
