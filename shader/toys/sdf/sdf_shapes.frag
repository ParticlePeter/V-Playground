...
//#if HW_PERFORMANCE==0     // OGL-ES predefined
//#define AA 1
//#else
...
layout( location = 0 ) in   vec2 fragCoord;  	// input from vertex shader
layout( location = 0 ) out  vec4 fragColor;     // output from fragment shader
